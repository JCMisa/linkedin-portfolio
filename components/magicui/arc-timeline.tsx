                    ...
                    >
                      <div
                        className={cn(
                          ...
                          isActive
                            ? "bg-[var(--step-line-active-color,#888888)] dark:bg-primary"
                      ...
                      >
                        ...
                        <p
                          className={cn(
                            "absolute bottom-0 left-1/2 line-clamp-3 flex w-[280px] -translate-x-1/2 translate-y-[calc(100%_+_42px)] items-center justify-center text-center text-sm transition-opacity duration-300 ease-in",
                            "text-[var(--description-color,#555555)] dark:text-[var(--description-color,#d4d4d4)] text-[10px]",
